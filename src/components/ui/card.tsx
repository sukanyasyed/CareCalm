  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: "bg-card/80 backdrop-blur-sm shadow-md border-border/50",
        metric: "bg-card shadow-md p-5 hover:shadow-lg hover:-translate-y-0.5",
        alert: "bg-destructive/5 border-destructive/20 shadow-sm",
